...
class XiGuaCrawler(object):
    ...
    page_url_format = "http://zs.xiguaji.com/MArticle/Attention/?position=2&dayInterval=6&articleType=-1&tags=%s&onlyTopLine=&page=%d&more=1"
